...
#content .detail_intro{ padding: 16px; text-align: justify; line-height: 26px;}
...
.detail_player .swiper-slide{ width:140px; height: 93px; margin-right: 20px; text-align: center; font-size: 14px;}
.detail_player .swiper-slide img{ width:100%; min-height: 93px; margin-bottom: 5px;}
